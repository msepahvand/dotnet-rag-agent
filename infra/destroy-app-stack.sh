...
ECR_REPOSITORY_NAME="${ECR_REPOSITORY_NAME:-dotnet-rag-agent}"
ECS_CLUSTER_NAME="${ECS_CLUSTER_NAME:-dotnet-rag-agent}"
ECS_SERVICE_NAME="${ECS_SERVICE_NAME:-dotnet-rag-agent}"
